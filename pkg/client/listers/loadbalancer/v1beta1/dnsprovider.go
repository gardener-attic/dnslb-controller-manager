...
type DNSProviderLister interface {
	...
	List(selector labels.Selector) (ret []*v1beta1.DNSProvider, err error)
...
// List lists all DNSProviders in the indexer.
func (s *dNSProviderLister) List(selector labels.Selector) (ret []*v1beta1.DNSProvider, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta1.DNSProvider))
	})
	return ret, err
}
...
type DNSProviderNamespaceLister interface {
	...
	Get(name string) (*v1beta1.DNSProvider, error)
...
// List lists all DNSProviders in the indexer for a given namespace.
func (s dNSProviderNamespaceLister) List(selector labels.Selector) (ret []*v1beta1.DNSProvider, err error) {
...
// Get retrieves the DNSProvider from the indexer for a given namespace and name.
func (s dNSProviderNamespaceLister) Get(name string) (*v1beta1.DNSProvider, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta1.Resource("dnsprovider"), name)
	}
	return obj.(*v1beta1.DNSProvider), nil
}
